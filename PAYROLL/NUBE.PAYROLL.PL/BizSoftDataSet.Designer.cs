    ...
    public partial class MonthlySalaryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[MonthlySalary] WHERE (([Id] = @Original_Id) AND ([EmployeeId] " +
                ...
                "ame] = @Original_EmployeeName)) AND ((@IsNull_EPFNumber = 1 AND [EPFNumber] IS N" +
                "ULL) OR ([EPFNumber] = @Original_EPFNumber)) AND ((@IsNull_SOCSONumber = 1 AND [" +
                "SOCSONumber] IS NULL) OR ([SOCSONumber] = @Original_SOCSONumber)) AND ((@IsNull_" +
                "NRIC = 1 AND [NRIC] IS NULL) OR ([NRIC] = @Original_NRIC)) AND ((@IsNull_BankAcc" +
                "ountNo = 1 AND [BankAccountNo] IS NULL) OR ([BankAccountNo] = @Original_BankAcco" +
                "untNo)) AND ([BasicSalary] = @Original_BasicSalary) AND ([TotalWorkingDays] = @O" +
                "riginal_TotalWorkingDays) AND ([DaysAbsent] = @Original_DaysAbsent) AND ([OTHour" +
                "s] = @Original_OTHours) AND ([OT_Amount] = @Original_OT_Amount) AND ([LOP] = @Or" +
                "iginal_LOP) AND ([POB] = @Original_POB) AND ([NEC] = @Original_NEC) AND ([SECOND" +
                "MENT] = @Original_SECONDMENT) AND ([SPECIAL] = @Original_SPECIAL) AND ([COLA] = " +
                "@Original_COLA) AND ([MOBILEALLOWANCE] = @Original_MOBILEALLOWANCE) AND ([ALLOWA" +
                "NCE] = @Original_ALLOWANCE) AND ([BONUS] = @Original_BONUS) AND ([EXGRATIA] = @O" +
                "riginal_EXGRATIA) AND ([EPF] = @Original_EPF) AND ([EPFUNION] = @Original_EPFUNI" +
                "ON) AND ([SOCSO] = @Original_SOCSO) AND ([SOCSOUNION] = @Original_SOCSOUNION) AN" +
                "D ([INCOMETAX] = @Original_INCOMETAX) AND ([GMIS] = @Original_GMIS) AND ([GELA] " +
                "= @Original_GELA) AND ([BIMBLOAN] = @Original_BIMBLOAN) AND ([HOMECARLOANS] = @O" +
                "riginal_HOMECARLOANS) AND ([OTHERLOAN] = @Original_OTHERLOAN) AND ([TOTALLOAN] =" +
                " @Original_TOTALLOAN) AND ([OTHERS] = @Original_OTHERS) AND ([KOPERASI] = @Origi" +
                "nal_KOPERASI) AND ([NUBESUBSCRIPTION] = @Original_NUBESUBSCRIPTION) AND ([PCB] =" +
                " @Original_PCB) AND ([TOTALEARNING] = @Original_TOTALEARNING) AND ([TOTALDEDUCTI" +
                "ON] = @Original_TOTALDEDUCTION) AND ([NETSALARY] = @Original_NETSALARY) AND ((@I" +
                "sNull_PositionName = 1 AND [PositionName] IS NULL) OR ([PositionName] = @Origina" +
                "l_PositionName)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[MonthlySalary] ([EmployeeId], [EmployeeNo], [SalaryMonth], [Em" +
                "ployeeName], [EPFNumber], [SOCSONumber], [NRIC], [BankAccountNo], [BasicSalary]," +
                " [TotalWorkingDays], [DaysAbsent], [OTHours], [OT_Amount], [LOP], [POB], [NEC], " +
                "[SECONDMENT], [SPECIAL], [COLA], [MOBILEALLOWANCE], [ALLOWANCE], [BONUS], [EXGRA" +
                "TIA], [EPF], [EPFUNION], [SOCSO], [SOCSOUNION], [INCOMETAX], [GMIS], [GELA], [BI" +
                "MBLOAN], [HOMECARLOANS], [OTHERLOAN], [TOTALLOAN], [OTHERS], [KOPERASI], [NUBESU" +
                "BSCRIPTION], [PCB], [TOTALEARNING], [TOTALDEDUCTION], [NETSALARY], [PositionName" +
                "]) VALUES (@EmployeeId, @EmployeeNo, @SalaryMonth, @EmployeeName, @EPFNumber, @S" +
                "OCSONumber, @NRIC, @BankAccountNo, @BasicSalary, @TotalWorkingDays, @DaysAbsent," +
                " @OTHours, @OT_Amount, @LOP, @POB, @NEC, @SECONDMENT, @SPECIAL, @COLA, @MOBILEAL" +
                "LOWANCE, @ALLOWANCE, @BONUS, @EXGRATIA, @EPF, @EPFUNION, @SOCSO, @SOCSOUNION, @I" +
                "NCOMETAX, @GMIS, @GELA, @BIMBLOAN, @HOMECARLOANS, @OTHERLOAN, @TOTALLOAN, @OTHER" +
                "S, @KOPERASI, @NUBESUBSCRIPTION, @PCB, @TOTALEARNING, @TOTALDEDUCTION, @NETSALAR" +
                "Y, @PositionName);\r\nSELECT Id, EmployeeId, EmployeeNo, SalaryMonth, EmployeeName" +
                ", EPFNumber, SOCSONumber, NRIC, BankAccountNo, BasicSalary, TotalWorkingDays, Da" +
                "ysAbsent, OTHours, OT_Amount, LOP, POB, NEC, SECONDMENT, SPECIAL, COLA, MOBILEAL" +
                "LOWANCE, ALLOWANCE, BONUS, EXGRATIA, EPF, EPFUNION, SOCSO, SOCSOUNION, INCOMETAX" +
                ", GMIS, GELA, BIMBLOAN, HOMECARLOANS, OTHERLOAN, TOTALLOAN, OTHERS, KOPERASI, NU" +
                "BESUBSCRIPTION, PCB, TOTALEARNING, TOTALDEDUCTION, NETSALARY, PositionName FROM " +
                "dbo.MonthlySalary WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[MonthlySalary] SET [EmployeeId] = @EmployeeId, [EmployeeNo] = @Empl" +
                "oyeeNo, [SalaryMonth] = @SalaryMonth, [EmployeeName] = @EmployeeName, [EPFNumber" +
                "] = @EPFNumber, [SOCSONumber] = @SOCSONumber, [NRIC] = @NRIC, [BankAccountNo] = " +
                "@BankAccountNo, [BasicSalary] = @BasicSalary, [TotalWorkingDays] = @TotalWorking" +
                "Days, [DaysAbsent] = @DaysAbsent, [OTHours] = @OTHours, [OT_Amount] = @OT_Amount" +
                ", [LOP] = @LOP, [POB] = @POB, [NEC] = @NEC, [SECONDMENT] = @SECONDMENT, [SPECIAL" +
                "] = @SPECIAL, [COLA] = @COLA, [MOBILEALLOWANCE] = @MOBILEALLOWANCE, [ALLOWANCE] " +
                "= @ALLOWANCE, [BONUS] = @BONUS, [EXGRATIA] = @EXGRATIA, [EPF] = @EPF, [EPFUNION]" +
                " = @EPFUNION, [SOCSO] = @SOCSO, [SOCSOUNION] = @SOCSOUNION, [INCOMETAX] = @INCOM" +
                "ETAX, [GMIS] = @GMIS, [GELA] = @GELA, [BIMBLOAN] = @BIMBLOAN, [HOMECARLOANS] = @" +
                "HOMECARLOANS, [OTHERLOAN] = @OTHERLOAN, [TOTALLOAN] = @TOTALLOAN, [OTHERS] = @OT" +
                "HERS, [KOPERASI] = @KOPERASI, [NUBESUBSCRIPTION] = @NUBESUBSCRIPTION, [PCB] = @P" +
                "CB, [TOTALEARNING] = @TOTALEARNING, [TOTALDEDUCTION] = @TOTALDEDUCTION, [NETSALA" +
                "RY] = @NETSALARY, [PositionName] = @PositionName WHERE (([Id] = @Original_Id) AN" +
                "D ([EmployeeId] = @Original_EmployeeId) AND ([EmployeeNo] = @Original_EmployeeNo" +
                ") AND ((@IsNull_SalaryMonth = 1 AND [SalaryMonth] IS NULL) OR ([SalaryMonth] = @" +
                "Original_SalaryMonth)) AND ((@IsNull_EmployeeName = 1 AND [EmployeeName] IS NULL" +
                ") OR ([EmployeeName] = @Original_EmployeeName)) AND ((@IsNull_EPFNumber = 1 AND " +
                "[EPFNumber] IS NULL) OR ([EPFNumber] = @Original_EPFNumber)) AND ((@IsNull_SOCSO" +
                "Number = 1 AND [SOCSONumber] IS NULL) OR ([SOCSONumber] = @Original_SOCSONumber)" +
                ") AND ((@IsNull_NRIC = 1 AND [NRIC] IS NULL) OR ([NRIC] = @Original_NRIC)) AND (" +
                "(@IsNull_BankAccountNo = 1 AND [BankAccountNo] IS NULL) OR ([BankAccountNo] = @O" +
                "riginal_BankAccountNo)) AND ([BasicSalary] = @Original_BasicSalary) AND ([TotalW" +
                "orkingDays] = @Original_TotalWorkingDays) AND ([DaysAbsent] = @Original_DaysAbse" +
                "nt) AND ([OTHours] = @Original_OTHours) AND ([OT_Amount] = @Original_OT_Amount) " +
                "AND ([LOP] = @Original_LOP) AND ([POB] = @Original_POB) AND ([NEC] = @Original_N" +
                "EC) AND ([SECONDMENT] = @Original_SECONDMENT) AND ([SPECIAL] = @Original_SPECIAL" +
                ") AND ([COLA] = @Original_COLA) AND ([MOBILEALLOWANCE] = @Original_MOBILEALLOWAN" +
                "CE) AND ([ALLOWANCE] = @Original_ALLOWANCE) AND ([BONUS] = @Original_BONUS) AND " +
                "([EXGRATIA] = @Original_EXGRATIA) AND ([EPF] = @Original_EPF) AND ([EPFUNION] = " +
                "@Original_EPFUNION) AND ([SOCSO] = @Original_SOCSO) AND ([SOCSOUNION] = @Origina" +
                "l_SOCSOUNION) AND ([INCOMETAX] = @Original_INCOMETAX) AND ([GMIS] = @Original_GM" +
                "IS) AND ([GELA] = @Original_GELA) AND ([BIMBLOAN] = @Original_BIMBLOAN) AND ([HO" +
                "MECARLOANS] = @Original_HOMECARLOANS) AND ([OTHERLOAN] = @Original_OTHERLOAN) AN" +
                "D ([TOTALLOAN] = @Original_TOTALLOAN) AND ([OTHERS] = @Original_OTHERS) AND ([KO" +
                "PERASI] = @Original_KOPERASI) AND ([NUBESUBSCRIPTION] = @Original_NUBESUBSCRIPTI" +
                "ON) AND ([PCB] = @Original_PCB) AND ([TOTALEARNING] = @Original_TOTALEARNING) AN" +
                "D ([TOTALDEDUCTION] = @Original_TOTALDEDUCTION) AND ([NETSALARY] = @Original_NET" +
                "SALARY) AND ((@IsNull_PositionName = 1 AND [PositionName] IS NULL) OR ([Position" +
                "Name] = @Original_PositionName)));\r\nSELECT Id, EmployeeId, EmployeeNo, SalaryMon" +
                "th, EmployeeName, EPFNumber, SOCSONumber, NRIC, BankAccountNo, BasicSalary, Tota" +
                "lWorkingDays, DaysAbsent, OTHours, OT_Amount, LOP, POB, NEC, SECONDMENT, SPECIAL" +
                ", COLA, MOBILEALLOWANCE, ALLOWANCE, BONUS, EXGRATIA, EPF, EPFUNION, SOCSO, SOCSO" +
                "UNION, INCOMETAX, GMIS, GELA, BIMBLOAN, HOMECARLOANS, OTHERLOAN, TOTALLOAN, OTHE" +
                "RS, KOPERASI, NUBESUBSCRIPTION, PCB, TOTALEARNING, TOTALDEDUCTION, NETSALARY, Po" +
                "sitionName FROM dbo.MonthlySalary WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT Id, EmployeeId, EmployeeNo, SalaryMonth, EmployeeName, EPFNumber, SOCSONumber, NRIC, BankAccountNo, BasicSalary, TotalWorkingDays, DaysAbsent, OTHours, OT_Amount, LOP, POB, NEC, SECONDMENT, SPECIAL, COLA, MOBILEALLOWANCE, ALLOWANCE, BONUS, EXGRATIA, EPF, EPFUNION, SOCSO, SOCSOUNION, INCOMETAX, GMIS, GELA, BIMBLOAN, HOMECARLOANS, OTHERLOAN, TOTALLOAN, OTHERS, KOPERASI, NUBESUBSCRIPTION, PCB, TOTALEARNING, TOTALDEDUCTION, NETSALARY, PositionName FROM dbo.MonthlySalary";
        ...
        public virtual int Delete(
            ...
            this.Adapter.DeleteCommand.Parameters[20].Value = ((decimal)(Original_LOP));
            this.Adapter.DeleteCommand.Parameters[21].Value = ((decimal)(Original_POB));
            this.Adapter.DeleteCommand.Parameters[22].Value = ((decimal)(Original_NEC));
            this.Adapter.DeleteCommand.Parameters[23].Value = ((decimal)(Original_SECONDMENT));
            this.Adapter.DeleteCommand.Parameters[24].Value = ((decimal)(Original_SPECIAL));
            this.Adapter.DeleteCommand.Parameters[25].Value = ((decimal)(Original_COLA));
            this.Adapter.DeleteCommand.Parameters[26].Value = ((decimal)(Original_MOBILEALLOWANCE));
            this.Adapter.DeleteCommand.Parameters[27].Value = ((decimal)(Original_ALLOWANCE));
            this.Adapter.DeleteCommand.Parameters[28].Value = ((decimal)(Original_BONUS));
            this.Adapter.DeleteCommand.Parameters[29].Value = ((decimal)(Original_EXGRATIA));
            this.Adapter.DeleteCommand.Parameters[30].Value = ((decimal)(Original_EPF));
            this.Adapter.DeleteCommand.Parameters[31].Value = ((decimal)(Original_EPFUNION));
            this.Adapter.DeleteCommand.Parameters[32].Value = ((decimal)(Original_SOCSO));
            this.Adapter.DeleteCommand.Parameters[33].Value = ((decimal)(Original_SOCSOUNION));
            this.Adapter.DeleteCommand.Parameters[34].Value = ((decimal)(Original_INCOMETAX));
            this.Adapter.DeleteCommand.Parameters[35].Value = ((decimal)(Original_GMIS));
            this.Adapter.DeleteCommand.Parameters[36].Value = ((decimal)(Original_GELA));
            this.Adapter.DeleteCommand.Parameters[37].Value = ((decimal)(Original_BIMBLOAN));
            this.Adapter.DeleteCommand.Parameters[38].Value = ((decimal)(Original_HOMECARLOANS));
            this.Adapter.DeleteCommand.Parameters[39].Value = ((decimal)(Original_OTHERLOAN));
            this.Adapter.DeleteCommand.Parameters[40].Value = ((decimal)(Original_TOTALLOAN));
            this.Adapter.DeleteCommand.Parameters[41].Value = ((decimal)(Original_OTHERS));
            this.Adapter.DeleteCommand.Parameters[42].Value = ((decimal)(Original_KOPERASI));
            this.Adapter.DeleteCommand.Parameters[43].Value = ((decimal)(Original_NUBESUBSCRIPTION));
            this.Adapter.DeleteCommand.Parameters[44].Value = ((decimal)(Original_PCB));
            this.Adapter.DeleteCommand.Parameters[45].Value = ((decimal)(Original_TOTALEARNING));
            this.Adapter.DeleteCommand.Parameters[46].Value = ((decimal)(Original_TOTALDEDUCTION));
            this.Adapter.DeleteCommand.Parameters[47].Value = ((decimal)(Original_NETSALARY));
            if ((Original_PositionName == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[49].Value = ((string)(Original_PositionName));
            }
        ...
        public virtual int Insert(
            ...
            this.Adapter.InsertCommand.Parameters[13].Value = ((decimal)(LOP));
            this.Adapter.InsertCommand.Parameters[14].Value = ((decimal)(POB));
            this.Adapter.InsertCommand.Parameters[15].Value = ((decimal)(NEC));
            this.Adapter.InsertCommand.Parameters[16].Value = ((decimal)(SECONDMENT));
            this.Adapter.InsertCommand.Parameters[17].Value = ((decimal)(SPECIAL));
            this.Adapter.InsertCommand.Parameters[18].Value = ((decimal)(COLA));
            this.Adapter.InsertCommand.Parameters[19].Value = ((decimal)(MOBILEALLOWANCE));
            this.Adapter.InsertCommand.Parameters[20].Value = ((decimal)(ALLOWANCE));
            this.Adapter.InsertCommand.Parameters[21].Value = ((decimal)(BONUS));
            this.Adapter.InsertCommand.Parameters[22].Value = ((decimal)(EXGRATIA));
            this.Adapter.InsertCommand.Parameters[23].Value = ((decimal)(EPF));
            this.Adapter.InsertCommand.Parameters[24].Value = ((decimal)(EPFUNION));
            this.Adapter.InsertCommand.Parameters[25].Value = ((decimal)(SOCSO));
            this.Adapter.InsertCommand.Parameters[26].Value = ((decimal)(SOCSOUNION));
            this.Adapter.InsertCommand.Parameters[27].Value = ((decimal)(INCOMETAX));
            this.Adapter.InsertCommand.Parameters[28].Value = ((decimal)(GMIS));
            this.Adapter.InsertCommand.Parameters[29].Value = ((decimal)(GELA));
            this.Adapter.InsertCommand.Parameters[30].Value = ((decimal)(BIMBLOAN));
            this.Adapter.InsertCommand.Parameters[31].Value = ((decimal)(HOMECARLOANS));
            this.Adapter.InsertCommand.Parameters[32].Value = ((decimal)(OTHERLOAN));
            this.Adapter.InsertCommand.Parameters[33].Value = ((decimal)(TOTALLOAN));
            this.Adapter.InsertCommand.Parameters[34].Value = ((decimal)(OTHERS));
            this.Adapter.InsertCommand.Parameters[35].Value = ((decimal)(KOPERASI));
            this.Adapter.InsertCommand.Parameters[36].Value = ((decimal)(NUBESUBSCRIPTION));
            this.Adapter.InsertCommand.Parameters[37].Value = ((decimal)(PCB));
            this.Adapter.InsertCommand.Parameters[38].Value = ((decimal)(TOTALEARNING));
            this.Adapter.InsertCommand.Parameters[39].Value = ((decimal)(TOTALDEDUCTION));
            this.Adapter.InsertCommand.Parameters[40].Value = ((decimal)(NETSALARY));
            if ((PositionName == null)) {
                this.Adapter.InsertCommand.Parameters[41].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.InsertCommand.Parameters[41].Value = ((string)(PositionName));
            }
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[13].Value = ((decimal)(LOP));
            this.Adapter.UpdateCommand.Parameters[14].Value = ((decimal)(POB));
            this.Adapter.UpdateCommand.Parameters[15].Value = ((decimal)(NEC));
            this.Adapter.UpdateCommand.Parameters[16].Value = ((decimal)(SECONDMENT));
            this.Adapter.UpdateCommand.Parameters[17].Value = ((decimal)(SPECIAL));
            this.Adapter.UpdateCommand.Parameters[18].Value = ((decimal)(COLA));
            this.Adapter.UpdateCommand.Parameters[19].Value = ((decimal)(MOBILEALLOWANCE));
            this.Adapter.UpdateCommand.Parameters[20].Value = ((decimal)(ALLOWANCE));
            this.Adapter.UpdateCommand.Parameters[21].Value = ((decimal)(BONUS));
            this.Adapter.UpdateCommand.Parameters[22].Value = ((decimal)(EXGRATIA));
            this.Adapter.UpdateCommand.Parameters[23].Value = ((decimal)(EPF));
            this.Adapter.UpdateCommand.Parameters[24].Value = ((decimal)(EPFUNION));
            this.Adapter.UpdateCommand.Parameters[25].Value = ((decimal)(SOCSO));
            this.Adapter.UpdateCommand.Parameters[26].Value = ((decimal)(SOCSOUNION));
            this.Adapter.UpdateCommand.Parameters[27].Value = ((decimal)(INCOMETAX));
            this.Adapter.UpdateCommand.Parameters[28].Value = ((decimal)(GMIS));
            this.Adapter.UpdateCommand.Parameters[29].Value = ((decimal)(GELA));
            this.Adapter.UpdateCommand.Parameters[30].Value = ((decimal)(BIMBLOAN));
            this.Adapter.UpdateCommand.Parameters[31].Value = ((decimal)(HOMECARLOANS));
            this.Adapter.UpdateCommand.Parameters[32].Value = ((decimal)(OTHERLOAN));
            this.Adapter.UpdateCommand.Parameters[33].Value = ((decimal)(TOTALLOAN));
            this.Adapter.UpdateCommand.Parameters[34].Value = ((decimal)(OTHERS));
            this.Adapter.UpdateCommand.Parameters[35].Value = ((decimal)(KOPERASI));
            this.Adapter.UpdateCommand.Parameters[36].Value = ((decimal)(NUBESUBSCRIPTION));
            this.Adapter.UpdateCommand.Parameters[37].Value = ((decimal)(PCB));
            this.Adapter.UpdateCommand.Parameters[38].Value = ((decimal)(TOTALEARNING));
            this.Adapter.UpdateCommand.Parameters[39].Value = ((decimal)(TOTALDEDUCTION));
            this.Adapter.UpdateCommand.Parameters[40].Value = ((decimal)(NETSALARY));
            if ((PositionName == null)) {
                this.Adapter.UpdateCommand.Parameters[41].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.UpdateCommand.Parameters[41].Value = ((string)(PositionName));
            }
            this.Adapter.UpdateCommand.Parameters[42].Value = ((int)(Original_Id));
            this.Adapter.UpdateCommand.Parameters[43].Value = ((int)(Original_EmployeeId));
            this.Adapter.UpdateCommand.Parameters[44].Value = ((int)(Original_EmployeeNo));
            if ((Original_SalaryMonth.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[45].Value = ((object)(0));
                this.Adapter.UpdateCommand.Parameters[46].Value = ((System.DateTime)(Original_SalaryMonth.Value));
            }
            else {
            ...
            if ((Original_EmployeeName == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[48].Value = ((string)(Original_EmployeeName));
            }
            if ((Original_EPFNumber == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[50].Value = ((string)(Original_EPFNumber));
            }
            if ((Original_SOCSONumber == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[52].Value = ((string)(Original_SOCSONumber));
            }
            if ((Original_NRIC == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[54].Value = ((string)(Original_NRIC));
            }
            if ((Original_BankAccountNo == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[57].Value = ((decimal)(Original_BasicSalary));
            this.Adapter.UpdateCommand.Parameters[58].Value = ((decimal)(Original_TotalWorkingDays));
            this.Adapter.UpdateCommand.Parameters[59].Value = ((decimal)(Original_DaysAbsent));
            this.Adapter.UpdateCommand.Parameters[60].Value = ((decimal)(Original_OTHours));
            this.Adapter.UpdateCommand.Parameters[61].Value = ((decimal)(Original_OT_Amount));
            this.Adapter.UpdateCommand.Parameters[62].Value = ((decimal)(Original_LOP));
            this.Adapter.UpdateCommand.Parameters[63].Value = ((decimal)(Original_POB));
            this.Adapter.UpdateCommand.Parameters[64].Value = ((decimal)(Original_NEC));
            this.Adapter.UpdateCommand.Parameters[65].Value = ((decimal)(Original_SECONDMENT));
            this.Adapter.UpdateCommand.Parameters[66].Value = ((decimal)(Original_SPECIAL));
            this.Adapter.UpdateCommand.Parameters[67].Value = ((decimal)(Original_COLA));
            this.Adapter.UpdateCommand.Parameters[68].Value = ((decimal)(Original_MOBILEALLOWANCE));
            this.Adapter.UpdateCommand.Parameters[69].Value = ((decimal)(Original_ALLOWANCE));
            this.Adapter.UpdateCommand.Parameters[70].Value = ((decimal)(Original_BONUS));
            this.Adapter.UpdateCommand.Parameters[71].Value = ((decimal)(Original_EXGRATIA));
            this.Adapter.UpdateCommand.Parameters[72].Value = ((decimal)(Original_EPF));
            this.Adapter.UpdateCommand.Parameters[73].Value = ((decimal)(Original_EPFUNION));
            this.Adapter.UpdateCommand.Parameters[74].Value = ((decimal)(Original_SOCSO));
            this.Adapter.UpdateCommand.Parameters[75].Value = ((decimal)(Original_SOCSOUNION));
            this.Adapter.UpdateCommand.Parameters[76].Value = ((decimal)(Original_INCOMETAX));
            this.Adapter.UpdateCommand.Parameters[77].Value = ((decimal)(Original_GMIS));
            this.Adapter.UpdateCommand.Parameters[78].Value = ((decimal)(Original_GELA));
            this.Adapter.UpdateCommand.Parameters[79].Value = ((decimal)(Original_BIMBLOAN));
            this.Adapter.UpdateCommand.Parameters[80].Value = ((decimal)(Original_HOMECARLOANS));
            this.Adapter.UpdateCommand.Parameters[81].Value = ((decimal)(Original_OTHERLOAN));
            this.Adapter.UpdateCommand.Parameters[82].Value = ((decimal)(Original_TOTALLOAN));
            this.Adapter.UpdateCommand.Parameters[83].Value = ((decimal)(Original_OTHERS));
            this.Adapter.UpdateCommand.Parameters[84].Value = ((decimal)(Original_KOPERASI));
            this.Adapter.UpdateCommand.Parameters[85].Value = ((decimal)(Original_NUBESUBSCRIPTION));
            this.Adapter.UpdateCommand.Parameters[86].Value = ((decimal)(Original_PCB));
            this.Adapter.UpdateCommand.Parameters[87].Value = ((decimal)(Original_TOTALEARNING));
            this.Adapter.UpdateCommand.Parameters[88].Value = ((decimal)(Original_TOTALDEDUCTION));
            this.Adapter.UpdateCommand.Parameters[89].Value = ((decimal)(Original_NETSALARY));
            if ((Original_PositionName == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[91].Value = ((string)(Original_PositionName));
            }
